...
class Item extends Component {
    render(){
        return(
            <div style={{color: 'white', width: 300, margin: 10, backgroundImage: `url(${this.props.image}), linear-gradient(rgba(69, 69, 69, 0.6) 0%, rgba(0, 0, 0, 0.5) 100%)`,filter: 'grayscale(100%)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
